...
class InferenceModel(ABC):
    """
    The InferenceModel abstract class is used as a template in the Fast Dynamic Batcher. An implementation of it must be passed to the DynBatcher.
    ...
    The infer method is then used to process batches of inputs.
